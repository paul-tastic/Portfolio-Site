...
$navbarMessage = "contractor: 'nerdypilot@contractor.com' - 'password' || user: 'nerdypilot@is-hired.com' - 'password'";
  ...
  <body>
		...
		<div id="c-box" class="d-none d-md-block">&#9400;2018 Paul McNeme, all rights reserved.
  		...
  		<div class="row">
	  		...
	  		<div class="col-md-7 offset-md-1" id="intro-screen-words">
		  		...
		  		<div id="contractor-words">
		  			<h1>Mow Me!</h1>
		  			<!-- Contractor Intro Words -->
		  			<p>Welcome landscape professionals!!</p>
		  			<p>Would you like to instantly reach thousands of property owners that need your services?</p>
		  			<p>Mowme allows you to control your schedule, your prices, and efficiently run (or start) your landscaping business.</p>
		  			<p>Some benefits of using our service</p>
		  			<ul>
		  				<li>easy billing controls, you get paid after every job is completed!</li>
		  				<li>we do all the marketing for you.</li>
		  				<li>instantly reach thousands of clients!</li>
		  				<li>fill your crews' schedule with minimal effort.</li>
		  				<li>schedule out impromptu jobs.</li>
		  				<li>build your new client list.</li>
		  				<li>no charge to bid on jobs.</li>
		  			</ul>
		  			<p>Sign up today and start bidding for free!</p>
		  			<p>We handle the finance side, so you can focus on your business -don't worry, our costs are very minimal. And we don't get paid unless you get the job!</p>
		  		</div>
	  		</div>
	  	</div> <!-- row -->
	</div>
    ...
    <script type="text/javascript">
    	...
    	$(document).on('click', '#contractor-login', function() {
    		...
    		$('#contractor-login-default').html('Contractors: Need to register? <span id="contractor-signup">Sign Up!</span>');
		...
		$(document).on('click', '#contractor-signup', function() {
    		...
    		$('#contractor-login-default').html('Contractors: Already registered? <span id="contractor-login">Sign In!</span>');
    		$('#navbar').removeClass('nav-border-user');
    		$('#navbar').addClass('nav-border-contractor');
    		$('#user-words').hide();
    		$('#contractor-words').show();
